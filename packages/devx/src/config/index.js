...
export async function getGlobalConfig() {
    ...
    if (existsSync(CONFIG_FILE_PATH)) {
        try {
            ...
            console.error(`Error reading or parsing global config ${CONFIG_FILE_PATH}:`, error);
    ...
    if (!validationResult.success) {
        console.warn('Invalid global configuration file. Using default values:', validationResult.error.flatten().fieldErrors);
